...
export default function DialogBlock({open,onCloseDialogDelete, onConfirmDelete, onCancelDelete}) {
    ...
    <div>
      ...
      >
        <DialogTitle style={{display: "flex", borderBottom:"1px solid #ccc", margin: "0 12px"}}>
          ...
          <span>Bạn có chắc chắn muốn thay đổi trạng thái tài khoản này hay không?</span>
        </DialogTitle>
        <DialogContent>
        </DialogContent>
