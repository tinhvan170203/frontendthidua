...
export default function TableChitietThiduanamTonghop({
  list,
  dennam
}) {
        ...
        <Table aria-label="custom pagination table">
          <TableHead>
            <TableRow>
              ...
              >
                Đơn vị công tác tính đến năm {dennam}
              </TableCell>
              <TableCell
                align="left"
                style={{
              ...
              >
                Kết quả xếp loại thi đua các năm
              </TableCell>
              <TableCell
                align="left"
                style={{
                 ...
                 <p>
                  {row.result.map(item=>(
                    <span className="flex items-start space-x-2">
                      <span className="text-red-600">- {item.nam}:</span>
