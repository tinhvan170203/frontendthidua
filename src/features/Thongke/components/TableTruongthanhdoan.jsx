...
export default function TableBangTruongthanhdoan({
  list,
  onChangeStatus
}) {
            ...
            {(rowsPerPage > 0
              ...
              <TableRow key={row._id} className="hover:bg-slate-200 transition duration-300">
                ...
                <TableCell
                  ...
                  align="left"
                >
                  {dayjs(row.ngaytruongthanhdoan).format("DD/MM/YYYY")}
                </TableCell>
                <TableCell
                  className="border-r border-slate-300"
                  align="left"
                >
                  {row.donvi.donvi.tendonvi}
                </TableCell>
                <TableCell
                  className="border-r border-slate-300"
                  align="right"
                >
                  {roles.includes("thay-doi-truong-thanh-doan") && (
                  <Button
                    variant="contained"
                    color="info"
                    size="small"
                  ...
                  >
                    Thay đổi trạng thái trưởng thành đoàn
                  </Button>
                  )}
                  <Button
                    variant="contained"
