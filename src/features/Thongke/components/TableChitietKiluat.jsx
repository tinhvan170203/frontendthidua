...
import BodyTableChitietCanhan from "./BodyTableChitietCanhan";
...
export default function TableChitietKiluat({
  list,
}) {
      ...
      <TableContainer component={Paper}>
        <Table aria-label="custom pagination table">
          ...
          <TableBody>
            {(rowsPerPage > 0
              ...
              : list
                ...
                <TableCell
                  ...
                  align="left"
                >
                  <span className="font-bold">{row.doituongkhen}</span>
                </TableCell>
                <TableCell
                  className="border-r border-slate-300"
                  align="left"
            ...
            color="info"
            size="small"
            onClick={()=> window.open(`/dashboard/chi-tiet-ca-nhan/${row.id_canhan}`, "_blank", "noreferrer")}
          >
            Trang cá nhân
          </Button>
                </TableCell>
