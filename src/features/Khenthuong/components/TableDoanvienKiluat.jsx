...
import BodyTableDoanvienKiluat from "./BodyTableDoanvienKiluat";
...
export default function TableDoanvienKiluat({
  list,
  onHandleChoiceCanbo
}) {
        ...
        <Table aria-label="custom pagination table">
          ...
          <TableBody>
            {(rowsPerPage > 0
              ...
              <BodyTableDoanvienKiluat
                row={row}
                key={row._id}
                page={page}
                rowsPerPage={rowsPerPage}
                index={index + 1}
                onHandleChoiceCanbo={onHandleChoiceCanbo}
              />
            ))}
            {emptyRows > 0 && (
