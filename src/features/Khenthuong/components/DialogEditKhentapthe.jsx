  ...
  useEffect(() => {
    if (item) {
      // console.log(item)
        ...
        setValue("hinhthuc", {label: item.hinhthuc.hinhthuckhen, value: item.hinhthuc._id}, { shouldValidate: true });
        setValue("capkhen", {label: item.capkhen.capkhen, value: item.capkhen._id}, { shouldValidate: true });
        ...
        <DialogContent>
          <Box>
            ...
            />
              ...
              <div className='flex-col md:basis-full flex flex-1 px-1'>
                <label className='underline font-semibold'><span className='text-red-600 font-semibold'> (*)</span>Tập thể được khen thưởng: </label>
                <Controller
              control={control}
