...
const KhoiComponent = () => {
  ...
  return (
   <div className='pr-2' data-aos="fade-left" data-aos-once="true">
     <div className='my-2'>
        <h4 className='uppercase font-bold text-blue-800 text-sm md:text-[18px]'>Quản lý khối, hệ, lực lượng</h4>
      </div>
  
      <form className='mt-2 mx-2 shadow-md py-4 px-2 shadow-gray-400' onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='flex space-x-2'>
          ...
          <div className='flex-col flex md:basis-1/2'>
            <label className='underline font-semibold'>Thuộc Công an tỉnh:</label>
            <Controller
              name="thuocCAT"
              control={control}
              render={({ field: { value, onChange } }) => (
      ...
      {/* table data  */}
      <div className='mt-6 mx-2 shadow-md shadow-gray-600'>
        <TableKhoi
          list={khois}
