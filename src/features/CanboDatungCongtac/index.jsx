  ...
  if (vaitro !== "Quản trị thông thường") {
    ...
    useEffect(() => {
        const fetchData = async () => {
            handleLoading(true);
            try {
                let res = await canboApi.fetchCanboTungCongtac();
    ...
    return (
        <div data-aos="fade-left" data-aos-once="true">
            <div className='my-2'>
                <h4 className='uppercase font-bold text-blue-800 text-sm md:text-[18px]'>Quản trị cán bộ, chiến sĩ đã từng công tác và hiện nay không còn công tác tại đơn vị</h4>
            </div>
            ...
            <div className='mt-6'>
                ...
                <div className='shadow-md shadow-gray-400 mr-2'>
                       <p className='text-center text-lg my-8 font-semibold mb-8'>Danh sách cán bộ, chiến sĩ đã từng công tác và hiện nay không còn công tác tại đơn vị</p>
                    <div className='px-2'>
                        <TableComponents
                            list={accounts}
                        />
...
export default CanboDatungCongtac