...
import BodyTableXeploaidangvien from "./BodyTableXeploaidangvien";
...
export default function TableXeploaidangvien({
    list,
    // all,
    onHandleChangeAll,
    onHandleChangeItem,
                    ...
                    <TableHead>
                        ...
                        <TableRow>
                            <TableCell colSpan={4}
                                ...
                                align="left"
                                style={{ fontWeight: "bold", padding: '2px 2px' }}></TableCell>
                            <TableCell
                                className="border-r border-slate-300"
                                align="left"
                                style={{ fontWeight: "bold", padding: '2px 2px' }}>
                                <select onChange={(e)=>onHandleChangeAll(e.target.value)} className="outline-none px-2 w-full" defaultValue={'null'}>
