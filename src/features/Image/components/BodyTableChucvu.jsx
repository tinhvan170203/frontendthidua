  ...
  return (
    <TableRow key={row._id} className="hover:bg-slate-200 transition duration-300">
      ...
      <TableCell
        ...
        align="left"
      >
        <img className="w-[300px]" src={`/img/${row.url}`} alt="img" />
      </TableCell>
      <TableCell
        className="border-r border-slate-300"
        align="left"
      ...
      <TableCell
        ...
        align="left"
      >
        {row.status === true ?<span className="text-blue-600 font-semibold">Hiển thị</span> : <span className="text-red-600 font-semibold">Không hiển thị</span>}
      </TableCell>
      <TableCell
        align="right"
