...
export default function TableKhactinh({
  list,
  onChangeStatus
}) {
        ...
        <Table aria-label="custom pagination table">
          <TableHead>
            <TableRow>
              ...
              >
                Đơn vị địa phương chuyển công tác đến
              </TableCell>
              <TableCell
                align="left"
                style={{
            ...
            {(rowsPerPage > 0
              ...
              <TableRow key={row._id} className="hover:bg-slate-200 transition duration-300">
                ...
                <TableCell
                  ...
                  align="left"
                >
                  <p className="truncate">{row.donvitruockhichuyen}</p>
                </TableCell>
                <TableCell
                  className="border-r border-slate-300"
                  align="left"
                >
                  <p className="truncate">{row.donvidiaphuongkhac.tenkhoi}</p>
                </TableCell>
                <TableCell
                  className="border-r border-slate-300"
                  align="left"
                >
                  {dayjs(row.ngaychuyendonvidiaphuongkhac).format("DD/MM/YYYY")}
                </TableCell>
                <TableCell
                  className="border-r border-slate-300"
                  align="right"
                >
                  ...
                  >
                    Thay đổi về đơn vị trong công an tỉnh
                  </Button>
                </TableCell>
              </TableRow>
            )})}
